...
import location from "../images/Icon/iconfinder-icon (1).svg";
    ...
    <div className={styles.box}>
      <div className={styles.box__upperCont}>
        <div className={styles.box__upperCont__user}>
          ...
          <div className={styles.box__upperCont__user__name}>{props.name}</div>
        </div>
        ...
        <div className={styles.box__upperCont__favXat}>
          ...
          <button className={styles.box__upperCont__favXat__xat}>Xateja</button>
        </div>
      </div>
      ...
      <div className={styles.box__details}>
        ...
        <div className={styles.box__details__categoria}>
          <span className={styles.box__details__categoria__tag}>Categoria </span>{props.categoria}
        </div>
        <div className={styles.box__details__etiquetes}>
          ...
          {props.tags}</div>
        <div className={styles.box__details__description}>{props.description}</div>

        <div className={styles.box__details__localitzacio}>
          <p className={styles.box__details__localitzacio__barri}>
            {props.barri},&nbsp;           <span className={styles.box__details__localitzacio__ciutat}>{props.ciutat}</span>
